...
let addr;
const sttaddr = "0xdda5c4DD71112643d030f84fFd7D1F69e3083258";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xdda5c4DD71112643d030f84fFd7D1F69e3083258";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bicyclerush.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xdda5c4DD71112643d030f84fFd7D1F69e3083258',
                    'symbol': 'BIR',
                    'decimals': '8',
                    'image': 'https://bicyclerush.net/images/logo.png',
                },
            },
